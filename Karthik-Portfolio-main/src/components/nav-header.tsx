...
export function NavHeader() {
  ...
  const portfolioText = "Karthikeya"
            ...
            {isDesktop && (
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1">
                  <a 
                    href="https://leetcode.com/u/22211a67b9/" 
                    target="_blank"
                ...
                <a
                  href="https://drive.google.com/file/d/13VGwGkzl34vfTdAgu6Go2d7Zfaewfnmc/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
